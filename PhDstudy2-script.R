...
GK100_WSC <- read_csv("gk100_1664060637512_compr_escr.csv")
GK100_SSC <- read_csv("gk100_1664059041164_compr_fala.csv")
GK100_V <- read_csv("gk100_1664057747966_vocabulario.csv")
GK100_LD <- read_csv("gk100_1664061010729_lex_escr.csv")
...
SVZ3Q_WSC <- read_csv("SIW5Y_1662855583104_compr_escr.csv")
SVZ3Q_SSC <- read_csv("SIW5Y_1662857460489_compr_fala.csv")
#SVZ3Q_V 
SVZ3Q_LD <- read_csv("SIW5Y_1662859330917_lex_escr.csv")
...
sub_J06WV_SC<-subset(J06WV_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_YY17D_SC<-subset(YY17D_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_PFV7U_SC<-subset(PFV7U_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_RIY5C_SC<-subset(RIY5C_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_TFCOE_SC<-subset(TFCOE_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_LJ81F_SC<-subset(LJ81F_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_AOHU7_SC<-subset(AOHU7_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_WFJR9_SC<-subset(WFJR9_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_UU4LD_SC<-subset(UU4LD_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_G5OXP_SC<-subset(G5OXP_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_T0U1A_SC<-subset(T0U1A_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_ZDAAP_SC<-subset(ZDAAP_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_YO81K_SC<-subset(YO81K_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_PO94X_SC<-subset(PO94X_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_G1T3T_SC<-subset(G1T3T_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_GTQL6_SC<-subset(GTQL6_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_I4IIX_SC<-subset(I4IIX_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_XXHX3_SC<-subset(XXHX3_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_SIW5Y_SC<-subset(SIW5Y_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_TAUUF_SC<-subset(TAUUF_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_UG7BS_SC<-subset(UG7BS_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_QIQMU_SC<-subset(QIQMU_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_KCKOS_SC<-subset(KCKOS_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_RYXE6_SC<-subset(RYXE6_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_XUEO6_SC<-subset(XUEO6_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_D0HAF_SC<-subset(D0HAF_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_IR1FT_SC<-subset(IR1FT_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_GK1OO_SC<-subset(GK1OO_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_S3GZ2_SC<-subset(S3GZ2_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_IGRI1_SC<-subset(IGRI1_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_GXQ0M_SC<-subset(GXQ0M_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_Z8OYV_SC<-subset(Z8OYV_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_TCHI1_SC<-subset(TCHI1_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_BV4CV_SC<-subset(BV4CV_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
sub_UE7T1_SC<-subset(UE7T1_SC, rt != "null" & trial_type != "instructions" & trial != "prac-sent" & trial != "prac-comp")
...
ok_J06WV_SC <- cbind(ok_J06WV_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_YY17D_SC <- cbind(ok_YY17D_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_PFV7U_SC <- cbind(ok_PFV7U_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_RIY5C_SC <- cbind(ok_RIY5C_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_TFCOE_SC <- cbind(ok_TFCOE_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_LJ81F_SC <- cbind(ok_LJ81F_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_AOHU7_SC <- cbind(ok_AOHU7_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_WFJR9_SC <- cbind(ok_WFJR9_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_UU4LD_SC <- cbind(ok_UU4LD_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_G5OXP_SC <- cbind(ok_G5OXP_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_T0U1A_SC <- cbind(ok_T0U1A_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_ZDAAP_SC <- cbind(ok_ZDAAP_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_YO81K_SC <- cbind(ok_YO81K_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_PO94X_SC <- cbind(ok_PO94X_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_G1T3T_SC <- cbind(ok_G1T3T_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_GTQL6_SC <- cbind(ok_GTQL6_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_I4IIX_SC <- cbind(ok_I4IIX_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_XXHX3_SC <- cbind(ok_XXHX3_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_SIW5Y_SC <- cbind(ok_SIW5Y_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_TAUUF_SC <- cbind(ok_TAUUF_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_UG7BS_SC <- cbind(ok_UG7BS_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_QIQMU_SC <- cbind(ok_QIQMU_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_KCKOS_SC <- cbind(ok_KCKOS_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_RYXE6_SC <- cbind(ok_RYXE6_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_XUEO6_SC <- cbind(ok_XUEO6_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_D0HAF_SC <- cbind(ok_D0HAF_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_IR1FT_SC <- cbind(ok_IR1FT_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_GK1OO_SC <- cbind(ok_GK1OO_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_S3GZ2_SC <- cbind(ok_S3GZ2_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_IGRI1_SC <- cbind(ok_IGRI1_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_GXQ0M_SC <- cbind(ok_GXQ0M_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_Z8OYV_SC <- cbind(ok_Z8OYV_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_TCHI1_SC <- cbind(ok_TCHI1_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_BV4CV_SC <- cbind(ok_BV4CV_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_UE7T1_SC <- cbind(ok_UE7T1_SC, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)

ok_J06WV_LD <- cbind(ok_J06WV_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_YY17D_LD <- cbind(ok_YY17D_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_PFV7U_LD <- cbind(ok_PFV7U_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_RIY5C_LD <- cbind(ok_RIY5C_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_TFCOE_LD <- cbind(ok_TFCOE_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_LJ81F_LD <- cbind(ok_LJ81F_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_AOHU7_LD <- cbind(ok_AOHU7_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_WFJR9_LD <- cbind(ok_WFJR9_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_UU4LD_LD <- cbind(ok_UU4LD_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_G5OXP_LD <- cbind(ok_G5OXP_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_T0U1A_LD <- cbind(ok_T0U1A_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_ZDAAP_LD <- cbind(ok_ZDAAP_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_YO81K_LD <- cbind(ok_YO81K_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_PO94X_LD <- cbind(ok_PO94X_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_G1T3T_LD <- cbind(ok_G1T3T_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_GTQL6_LD <- cbind(ok_GTQL6_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_I4IIX_LD <- cbind(ok_I4IIX_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_XXHX3_LD <- cbind(ok_XXHX3_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_SIW5Y_LD <- cbind(ok_SIW5Y_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_TAUUF_LD <- cbind(ok_TAUUF_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_UG7BS_LD <- cbind(ok_UG7BS_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_QIQMU_LD <- cbind(ok_QIQMU_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_KCKOS_LD <- cbind(ok_KCKOS_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_RYXE6_LD <- cbind(ok_RYXE6_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_XUEO6_LD <- cbind(ok_XUEO6_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_D0HAF_LD <- cbind(ok_D0HAF_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_IR1FT_LD <- cbind(ok_IR1FT_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_GK1OO_LD <- cbind(ok_GK1OO_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_S3GZ2_LD <- cbind(ok_S3GZ2_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_IGRI1_LD <- cbind(ok_IGRI1_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_GXQ0M_LD <- cbind(ok_GXQ0M_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_Z8OYV_LD <- cbind(ok_Z8OYV_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_TCHI1_LD <- cbind(ok_TCHI1_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_BV4CV_LD <- cbind(ok_BV4CV_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
ok_UE7T1_LD <- cbind(ok_UE7T1_LD, Vscore = 127, Vpcent = 97.69231, age = 46, year = 2017)
